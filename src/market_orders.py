...
def main():
    parser = argparse.ArgumentParser(description="Place a market order (USDT-M Futures).")
    ...
    try:
        ...
        resp = place_order(client, symbol, args.side, "MARKET", args.quantity)
        print("Response:", resp)
    except Exception as e:
        _log("error", "market_order_failed", {"error": str(e)})
        raise
